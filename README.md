...
To run Tockilator, you will need to Verilator trace files, ELF binaries of
the software running for the trace, and the Tockilator binary itself.
If you want to experiment without having Verilator configured, see
some of the fully worked <a href="./examples/libtock-rs">libtock-rs examples</a>.
